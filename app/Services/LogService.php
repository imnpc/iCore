...
class LogService
{
     ...
     * @throws \Throwable
     */
    public function userWalletLog(int $uid, int $wallet_type_id, float|int $add, int $from_uid = 0, string $day = '2025-01-01', int $from = 0, string $remark = '', int $order_id = 0): void
    {
