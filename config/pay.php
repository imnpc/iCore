...
return [
    'alipay' => [
        'default' => [
            ...
            // 必填-应用公钥证书 路径
            'app_public_cert_path' => storage_path('certs/appCertPublicKey.crt'),
            // 必填-支付宝公钥证书 路径
            'alipay_public_cert_path' => storage_path('certs/alipayCertPublicKey_RSA2.crt'),
            // 必填-支付宝根证书 路径
            'alipay_root_cert_path' => storage_path('certs/alipayRootCert.crt'),
            'return_url' => env("APP_URL").'/api/v1/alipay/notify',
            'notify_url' => env("APP_URL").'/api/v1/alipay/notify',
    ...
    'wechat' => [
        'default' => [
            ...
            // 必填-商户私钥 字符串或路径
            'mch_secret_cert' => storage_path('certs/apiclient_key.pem'),
            // 必填-商户公钥证书路径
            'mch_public_cert_path' => storage_path('certs/apiclient_cert.pem'),
            // 必填
            'notify_url' => env("APP_URL").'/api/v1/wechat/notify',
            // 选填-公众号 的 app_id
